...
<!DOCTYPE html>
<html>
<head><title>Home page</title><link rel="stylesheet" type="text/css" href="style1.css"></head>

<body style="background: #128184 ">
    <div class="headerhome"><h2>Home_Page</h2>
        <p>Not have acount?<a href="Register.php">Sign_Up</a></p>
        <p>Have Acount?<a href="login.php">Login</a></p>
        <p>add<a href="adminpanel.php">adminpanel</a></p>
	</div>
...
<head>
	...
	<title>Rigesteration Form</title><link rel="stylesheet" type="text/css" href="stylehome.css">
</head>
